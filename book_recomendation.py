...
"""#### Feature extraction TF-IDF dan CountVectorizer

mengubah data teks buku menjadi vektor angka menggunakan CountVectorizer lalu menghitung kemiripan antar buku berdasarkan kontennya
"""

vectorizer_cv = CountVectorizer()
vectors_cv = vectorizer_cv.fit_transform(full_data["all_features"])

"""mengubah data teks buku menjadi vektor angka menggunakan TF-IDF lalu menghitung kemiripan antar buku berdasarkan kontennya"""
...
"""memvisualisasikan permorma model saat test"""

plt.figure(figsize=(10, 6))
plt.plot(history.history['root_mean_squared_error'], label='Train RMSE')
plt.plot(history.history['val_root_mean_squared_error'], label='Validation RMSE')
plt.hlines(test_rmse, 0, len(history.history['root_mean_squared_error'])-1,
           colors='red', linestyles='dashed', label=f'Test RMSE: {test_rmse:.4f}')
